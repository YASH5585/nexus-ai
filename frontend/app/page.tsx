      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl text-center">
          ...
          >
            ...
            <span className="block text-3xl sm:text-4xl lg:text-5xl font-normal text-zinc-400 mt-2">
              Self-Healing Software Engineer
            </span>
          </motion.h1>
          ...
          >
            Nexus AI is a self-healing autonomous agent that writes code, runs it in secure sandboxes,
